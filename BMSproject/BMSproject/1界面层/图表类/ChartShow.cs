...
namespace BMSproject
{
    ...
    public class ChartShow
    {
        ...
        public void ShowData(SeriesChartType chartType, List<ChartData> dataList)
        {
            //【1】清除所有的图表序列
